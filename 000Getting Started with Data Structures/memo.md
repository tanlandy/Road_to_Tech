...
## Node
1. ontain data, which can be a variety of data types
2. Contain links to other nodes. If a node has no links, or they are 3. all null, you have reached the end of the path you were following.
